...
import com.smart.ticketing.backendless.RegisterActivity;
                    ...
                    querydata.find(query, new AsyncCallback<List<Users>>() {
                        ...
                        public void handleResponse(List<Users> response) {
                            if(response.size() > 0 ){
                                ...
                                sms.sendTextMessage(response.get(0).getPhone(), null , "Your password: " + response.get(0).getPass(),null, null);
